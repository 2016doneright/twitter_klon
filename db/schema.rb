...
ActiveRecord::Schema.define(version: 20151116162118) do
  ...
  add_index "retweets", ["user_id", "tweet_id"], name: "index_retweets_on_user_id_and_tweet_id", unique: true
  ...
  add_index "users", ["real_name"], name: "index_users_on_real_name", unique: true
